...
<script>
    ...
    let data = [];
    let categories = ['BEEF', 'PORK', 'CEREALS RTE', 'BABYFOOD', 'LAMB', 'SOUP', 'CHICKEN', 'CEREALS', 'FAST FOODS', 'CANDIES'];
    let nutrients = ['Data.Protein', 'Data.Carbohydrate', 'Data.Fat.Total Lipid', 'Data.Sugar Total', 'Data.Fiber', 'Data.Major Minerals.Sodium', 'Data.Major Minerals.Calcium', 'Data.Vitamins.Vitamin C', 'Data.Vitamins.Vitamin B12', 'Data.Major Minerals.Iron'];  
